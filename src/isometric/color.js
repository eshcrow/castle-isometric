...
function Color (r, g, b, a) {
  this.r = parseInt(r || 0, DECIMAL)
  this.g = parseInt(g || 0, DECIMAL)
  this.b = parseInt(b || 0, DECIMAL)
...
Color.prototype.loadRGB = function () {
  ...
  this.r = parseInt(r * 255, DECIMAL)
  this.g = parseInt(g * 255, DECIMAL)
  this.b = parseInt(b * 255, DECIMAL)
}

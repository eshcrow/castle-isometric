...
var actions = _reflux2.default.createActions(['load', 'placeTile']);

exports.default = actions;

},{"reflux":"reflux"}],293:[function(require,module,exports){
'use strict';
...
_reactDom2.default.render(_react2.default.createElement(_game2.default, null), document.getElementById('castle-app'));

_actions2.default.load();

},{"./actions":292,"./game.jsx":295,"babel-polyfill":1,"react":"react","react-dom":"react-dom"}],294:[function(require,module,exports){
'use strict';
...
var _viewport = require('./viewport.jsx');
...
var _controlBar = require('./control-bar.jsx');
...
},{"./control-bar.jsx":294,"./viewport.jsx":313,"./world.jsx":315,"react":"react"}],296:[function(require,module,exports){
'use strict';
...
var CitySection = function (_Section) {
  _inherits(CitySection, _Section);

  function CitySection() {
    _classCallCheck(this, CitySection);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(CitySection).call(this, 'CITY'));
  }

  return CitySection;
}(_section2.default);

exports.default = CitySection;

},{"./section":301}],297:[function(require,module,exports){
'use strict';
...
var FarmSection = function (_Section) {
  _inherits(FarmSection, _Section);

  function FarmSection() {
    _classCallCheck(this, FarmSection);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(FarmSection).call(this, 'FARM'));
  }

  return FarmSection;
}(_section2.default);

exports.default = FarmSection;

},{"./section":301}],298:[function(require,module,exports){
'use strict';
...
},{"./world":304}],299:[function(require,module,exports){
'use strict';
...
var Position = function () {
  ...
  _createClass(Position, [{
    ...
    value: function neighbours() {
      return [new Position(this.x, this.y - 1), new Position(this.x, this.y + 1), new Position(this.x - 1, this.y), new Position(this.x + 1, this.y)];
    }
  }]);
...
var RoadSection = function (_Section) {
  _inherits(RoadSection, _Section);

  function RoadSection() {
    _classCallCheck(this, RoadSection);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(RoadSection).call(this, 'ROAD'));
  }

  return RoadSection;
}(_section2.default);

exports.default = RoadSection;

},{"./section":301}],301:[function(require,module,exports){
'use strict';
...
var Section = function Section(type) {
...
var TileEdge = function () {
  ...
  _createClass(TileEdge, [{
    key: 'canConnectTo',
    value: function canConnectTo(otherTileEdge) {
      if (this.sections.length !== otherTileEdge.sections.length) {
        return false;
      }
      return this.sections.reverse().every(function (section, index) {
...
exports.buildTileV = exports.buildTileD = undefined;

var _tileEdge = require('./tile-edge.js');

var _tileEdge2 = _interopRequireDefault(_tileEdge);

var _citySection = require('./city-section.js');

var _citySection2 = _interopRequireDefault(_citySection);

var _farmSection = require('./farm-section.js');

var _farmSection2 = _interopRequireDefault(_farmSection);

var _roadSection = require('./road-section');

var _roadSection2 = _interopRequireDefault(_roadSection);
...
function buildTileD() {
  var cityA = new _citySection2.default();
  var farmA = new _farmSection2.default();
  var farmB = new _farmSection2.default();
  var roadA = new _roadSection2.default();

  var edgeN = new _tileEdge2.default(farmA, roadA, farmB);
  var edgeE = new _tileEdge2.default(cityA);
  var edgeS = new _tileEdge2.default(farmB, roadA, farmA);
  var edgeW = new _tileEdge2.default(farmA);
...
function buildTileV() {
  ...
  var edgeN = new _tileEdge2.default(farmA);
  var edgeE = new _tileEdge2.default(farmA);
  var edgeS = new _tileEdge2.default(farmA, roadA, farmB);
  var edgeW = new _tileEdge2.default(farmB, roadA, farmA);
...
exports.buildTileD = buildTileD;
exports.buildTileV = buildTileV;

},{"./city-section.js":296,"./farm-section.js":297,"./road-section":300,"./tile-edge.js":302}],304:[function(require,module,exports){
'use strict';
...
World.prototype.canPlaceTile = function (tile, position, orientation) {
  ...
  function checkEdge(neighbourPosition, edgeOrientation) {
    var neighbour = world.tiles[neighbourPosition.toString()];
    if (!neighbour) {
      return true;
    }
    var neighbourEdge = neighbour.tile.edges[or(edgeOrientation, neighbour.orientation)];
    var edge = tile.edges[or(edgeOrientation + 2, orientation)];
    return edge.canConnectTo(neighbourEdge);
  }

  return checkEdge(new _position2.default(position.x + 1, position.y), 2) && checkEdge(new _position2.default(position.x - 1, position.y), 0) && checkEdge(new _position2.default(position.x, position.y + 1), 3) && checkEdge(new _position2.default(position.x, position.y - 1), 1);
};
    ...
    positionedTile.position.neighbours().forEach(function (neighbour) {
      ...
      if (!world.tiles[key] && !positions[key]) {
        (function () {
          ...
          var o = [0, 1, 2, 3];
          o.forEach(function (orientation) {
...
},{"./position":299}],305:[function(require,module,exports){
'use strict';
...
function Cuboid(options) {
  ...
  var face1 = new Path([origin, origin.translate(dx, 0, 0), origin.translate(dx, 0, dz), origin.translate(0, 0, dz)], color);

  var face2 = new Path([origin, origin.translate(0, 0, dz), origin.translate(0, dy, dz), origin.translate(0, dy, 0)], color);

  var face3 = new Path([origin, origin.translate(dx, 0, 0), origin.translate(dx, dy, 0), origin.translate(0, dy, 0)], color);
...
},{"./path":308,"./shape":310}],307:[function(require,module,exports){
'use strict';
...
},{"./color.js":305,"./vector.js":311}],308:[function(require,module,exports){
'use strict';
...
},{"./vector":311}],309:[function(require,module,exports){
'use strict';
...
},{"./path":308}],311:[function(require,module,exports){
'use strict';
...
var placeTilePhaseStore = _reflux2.default.createStore({
  init: function init() {
    this.listenTo(_actions2.default.placeTile, this.placeTile);
  },
  placeTile: function placeTile(tile, position, orientation) {
    this.trigger({
      tile: tile,
      position: position,
      orientation: orientation
...
},{"./actions":292,"./game/game":298,"reflux":"reflux"}],313:[function(require,module,exports){
'use strict';
...
var Viewport = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      'svg',
      { id: 'world', height: '100', width: '100', viewBox: this.calculateViewBox(), onMouseMove: this.onMouseMove },
      React.createElement('polygon', { ref: 'viewportScale', points: viewportScalePoints }),
      this.props.children
    );
  },
  ...
  calculateViewBox: function calculateViewBox() {
...
var _tile = require('./game/tile');

var _game = require('./game/game');

var _game2 = _interopRequireDefault(_game);

var _position = require('./game/position');

var _position2 = _interopRequireDefault(_position);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var worldStore = _reflux2.default.createStore({
  init: function init() {
    this.game = new _game2.default();
    this.game.world.remainingTiles.push((0, _tile.buildTileD)());
    this.game.world.remainingTiles.push((0, _tile.buildTileV)());
    this.listenTo(_actions2.default.placeTile, this.placeTile);
    this.listenTo(_actions2.default.load, this.load);
  },
  load: function load() {
    this.game.world.placeTile((0, _tile.buildTileD)(), new _position2.default(0, 0), 0);
    this.update();
  },
  placeTile: function placeTile(tile, position, orientation) {
...
},{"./actions":292,"./game/game":298,"./game/position":299,"./game/tile":303,"reflux":"reflux"}],315:[function(require,module,exports){
'use strict';
...
var _tile = require('./world/tiles/tile');

var _tile2 = _interopRequireDefault(_tile);

var _tilePlaceholder = require('./world/tiles/tile-placeholder');

var _tilePlaceholder2 = _interopRequireDefault(_tilePlaceholder);

var _worldStore = require('./world-store');

var _worldStore2 = _interopRequireDefault(_worldStore);
...
var World = _react2.default.createClass({
  ...
  componentDidMount: function componentDidMount() {
    this.unsubscribe = _worldStore2.default.listen(this.onWorldChange);
  },
  componentWillUnmount: function componentWillUnmount() {
    this.unsubscribe();
  },
  onWorldChange: function onWorldChange(world) {
    var index = 0; //Math.floor(Math.random() * world.remainingTiles.length);
    var tileToPlace = world.remainingTiles[index];
  ...
  render: function render() {
    ...
    var renderedTiles = this.state.tiles.map(function (placedTile) {
      return {
        depth: _this.depth(placedTile.position),
        render: _this.renderTile(placedTile)
      };
    });

    var renderedPlaceholders = this.state.possiblePlacements.map(function (possiblePlacement) {
      return {
        depth: _this.depth(possiblePlacement.position),
        render: _this.renderPlaceholder(possiblePlacement)
      };
    });

    var renders = renderedTiles.concat(renderedPlaceholders).sort(this.sortByDepth).map(function (tile) {
      return tile.render;
    });
  ...
  tileKey: function tileKey(_ref) {
    var x = _ref.x;
    var y = _ref.y;

    return 'world.tile-' + x + '-' + y;
  },
  renderTile: function renderTile(_ref2) {
    var tile = _ref2.tile;
    var position = _ref2.position;
    var orientation = _ref2.orientation;

    return _react2.default.createElement(_tile2.default, { tile: tile, position: position, orientation: orientation, key: this.tileKey(position) });
  },
  renderPlaceholder: function renderPlaceholder(_ref3) {
    var tile = _ref3.tile;
    var position = _ref3.position;
    var orientations = _ref3.orientations;

    return _react2.default.createElement(_tilePlaceholder2.default, { tile: this.state.tileToPlace, position: position, orientations: orientations, key: this.tileKey(position) });
  },
  sortByDepth: function sortByDepth(a, b) {
    var depthA = a.depth;
    var depthB = b.depth;
    if (depthA < depthB) {
      return 1;
...
},{"./world-store":314,"./world/tiles/tile":322,"./world/tiles/tile-placeholder":320,"react":"react"}],316:[function(require,module,exports){
'use strict';
...
var angle = Math.PI / 6;
var scale = 2;
var transformation = [[Math.cos(angle), Math.sin(angle)], [Math.cos(Math.PI - angle), Math.sin(Math.PI - angle)]];

var PathGraphic = React.createClass({
  displayName: 'PathGraphic',
  ...
  render: function render() {
    ...
    return React.createElement('polygon', { points: points, style: style, zIndex: this.props.zIndex });
  }
...
function translatePoint(point) {
   ...
   */
  var xMap = new Point(point.x * scale * transformation[0][0], point.x * scale * transformation[0][1]);

  var yMap = new Point(point.y * scale * transformation[1][0], point.y * scale * transformation[1][1]);
...
},{"../../isometric/point":309,"react":"react"}],317:[function(require,module,exports){
'use strict';
...
var ShapeGraphic = React.createClass({
  ...
  render: function render() {
    ...
    var paths = shape.paths.filter(function (path) {
      return path.isFacing(new Vector(-2, -1, 3));
    });
    ...
    return React.createElement(
      ...
      paths.map(function (path, index) {
        ...
        return React.createElement(PathGraphic, { key: index, path: path, style: style, zIndex: zIndex });
      })
    );
  }
...
},{"../../isometric/color":305,"../../isometric/cuboid":306,"../../isometric/light":307,"../../isometric/point":309,"../../isometric/vector":311,"./path-graphic":316,"react":"react"}],318:[function(require,module,exports){
'use strict';
...
var _shapeGraphic = require('../shapes/shape-graphic');

var _shapeGraphic2 = _interopRequireDefault(_shapeGraphic);

var _color = require('../../isometric/color');

var _color2 = _interopRequireDefault(_color);

var _point = require('../../isometric/point');
...
var COLOR_GRASS = new _color2.default(138, 179, 73);
var COLOR_DIRT = new _color2.default(180, 139, 94);

var ORIENTATION_ANGLE = Math.PI / 180 * 90;

var TileBase = function (_React$Component) {
  _inherits(TileBase, _React$Component);

  function TileBase() {
    _classCallCheck(this, TileBase);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(TileBase).apply(this, arguments));
  }

  _createClass(TileBase, [{
    key: 'origin',
    value: function origin() {
      return new _point2.default(10 * this.props.position.x - 5, 10 * this.props.position.y - 5, 0);
    }
  }, {
    key: 'orientate',
    value: function orientate(shape) {
      return shape.rotateZ(this.origin().translate(5, 5, 0), ORIENTATION_ANGLE * this.props.orientation);
    }
  }, {
    key: 'render',
    value: function render() {
      var grassPosition = this.origin().translate(0, 0, -1);
      var dirtPosition = this.origin().translate(0, 0, -2);
      return _react2.default.createElement(
        'g',
        null,
        _react2.default.createElement(_shapeGraphic2.default, { position: dirtPosition, dx: 10, dy: 10, dz: 1, color: COLOR_DIRT, zIndex: '2' }),
        _react2.default.createElement(_shapeGraphic2.default, { position: grassPosition, dx: 10, dy: 10, dz: 1, color: COLOR_GRASS, zIndex: '3' })
      );
    }
  }]);
...
},{"../../isometric/color":305,"../../isometric/point":309,"../shapes/shape-graphic":317,"react":"react"}],319:[function(require,module,exports){
'use strict';
...
var _pathGraphic = require('../shapes/path-graphic');

var _pathGraphic2 = _interopRequireDefault(_pathGraphic);

var _color = require('../../isometric/color');

var _color2 = _interopRequireDefault(_color);

var _path = require('../../isometric/path');

var _path2 = _interopRequireDefault(_path);

var _tileBase = require('./tile-base');
...
var COLOR_CITY = new _color2.default(180, 139, 94);
var COLOR_ROAD = new _color2.default(217, 207, 154);
var ROAD_WIDTH = 1.5;

var TileD = function (_TileBase) {
  _inherits(TileD, _TileBase);

  function TileD() {
    _classCallCheck(this, TileD);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(TileD).apply(this, arguments));
  }
  ...
  _createClass(TileD, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'g',
        null,
        _get(Object.getPrototypeOf(TileD.prototype), 'render', this).call(this),
        _react2.default.createElement(_tree2.default, { position: treePosition }),
        _react2.default.createElement(_pathGraphic2.default, { path: road, zIndex: '0' }),
        _react2.default.createElement(_pathGraphic2.default, { path: city })
      );
    }
  }, {
    key: 'buildRoad',
    value: function buildRoad(position) {
      var halfRoadWidth = ROAD_WIDTH / 2;
      var road = new _path2.default([position.translate(10, 5 - halfRoadWidth, 0), position.translate(10, 5 + halfRoadWidth, 0), position.translate(0, 5 + halfRoadWidth, 0), position.translate(0, 5 - halfRoadWidth, 0)], COLOR_ROAD);
      return this.orientate(road);
    }
  }, {
    key: 'buildCity',
    value: function buildCity(position) {
      var city = new _path2.default([position.translate(10, 10, 0), position.translate(7.5, 7.5, 0), position.translate(2.5, 7.5, 0), position.translate(0, 10, 0)], COLOR_CITY);
...
},{"../../isometric/color":305,"../../isometric/path":308,"../shapes/path-graphic":316,"../tree.jsx":323,"./tile-base":318,"react":"react"}],320:[function(require,module,exports){
'use strict';
...
var _placeTilePhaseStore = require('../../place-tile-phase-store');

var _placeTilePhaseStore2 = _interopRequireDefault(_placeTilePhaseStore);
...
var TilePlaceholder = function (_React$Component) {
  _inherits(TilePlaceholder, _React$Component);

  function TilePlaceholder(props) {
    _classCallCheck(this, TilePlaceholder);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TilePlaceholder).call(this, props));

    _this.placeTile = _this.placeTile.bind(_this);
  ...
  _createClass(TilePlaceholder, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      this.unsubscribe = _placeTilePhaseStore2.default.listen(this.onPlaceTilePhaseChanged.bind(this));
    }
  }, {
    ...
    key: 'onPlaceTilePhaseChanged',
    value: function onPlaceTilePhaseChanged(_ref) {
    ...
    value: function render() {
      ...
      return React.createElement(
        'g',
        { className: classNames, onClick: this.placeTile, onContextMenu: this.rotate },
        React.createElement(_tile2.default, { tile: this.props.tile, position: this.props.position, orientation: this.selectedOrientation() })
      );
    }
  }, {
    key: 'selectedOrientation',
    value: function selectedOrientation() {
      var index = this.state.orientationIndex % this.props.orientations.length;
      return this.props.orientations[index];
    }
  }, {
    key: 'placeTile',
    value: function placeTile() {
      _actions2.default.placeTile(this.props.tile, this.props.position, this.selectedOrientation());
    }
  }, {
    key: 'rotate',
...
},{"../../actions":292,"../../place-tile-phase-store":312,"./tile":322,"react":"react"}],321:[function(require,module,exports){
'use strict';
...
var TileV = _react2.default.createClass({
  displayName: 'TileV',


  render: function render() {
    var position = new _point2.default(10 * this.props.position.x - 5, 10 * this.props.position.y - 5, 0);
    var center = position.translate(5, 5, 0);
    ...
    var road = new _path2.default([position.translate(0, 5 + halfRoadWidth, 0), position.translate(5 + halfRoadWidth, 5 + halfRoadWidth, 0), position.translate(5 + halfRoadWidth, 0, 0), position.translate(5 - halfRoadWidth, 0, 0), position.translate(5 - halfRoadWidth, 5 - halfRoadWidth, 0), position.translate(0, 5 - halfRoadWidth, 0)], COLOR_ROAD);
    ...
    return _react2.default.createElement(
      'g',
      null,
      _react2.default.createElement(_shapeGraphic2.default, { position: dirtPosition, dx: 10, dy: 10, dz: 1, color: COLOR_DIRT }),
      _react2.default.createElement(_shapeGraphic2.default, { position: grassPosition, dx: 10, dy: 10, dz: 1, color: COLOR_GRASS }),
      _react2.default.createElement(_pathGraphic2.default, { path: road })
    );
  }

});

exports.default = TileV;

},{"../../isometric/color":305,"../../isometric/path":308,"../../isometric/point":309,"../shapes/path-graphic":316,"../shapes/shape-graphic":317,"react":"react"}],322:[function(require,module,exports){
'use strict';

var _tileD = require('./tile-d.jsx');

var _tileD2 = _interopRequireDefault(_tileD);

var _tileV = require('./tile-v.jsx');

var _tileV2 = _interopRequireDefault(_tileV);
...
var Tile = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(TileType, { tile: this.props.tile, position: this.props.position, orientation: this.props.orientation });
  }
});

module.exports = Tile;

},{"./tile-d.jsx":319,"./tile-v.jsx":321,"react":"react"}],323:[function(require,module,exports){
'use strict';
...
var COLOR_LEAVES = new _color2.default(138, 179, 73);
var COLOR_TRUNK = new _color2.default(180, 139, 94);
...
var Tree = function (_React$Component) {
  ...
  _createClass(Tree, [{
    key: 'render',
    value: function render() {
      var trunkShape = new _path2.default([new _point2.default(-1, 0), new _point2.default(1, 0), new _point2.default(1, 3), new _point2.default(-1, 3)]);
      return _react2.default.createElement(
        'g',
        null,
        _react2.default.createElement(Shape2D, { position: this.props.position, shape: trunkShape, color: COLOR_TRUNK })
      );
    }
  }]);
...
},{"../isometric/color":305,"../isometric/path":308,"../isometric/point":309,"./shapes/shape-graphic":317,"react":"react"}]},{},[293]);
